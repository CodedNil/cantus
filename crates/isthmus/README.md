...
Isthmus should make typed Rust the single source of truth for CPU-to-GPU rendering without limiting what WGPU or Rust-GPU can express.
...
- Treat portable WebGPU as the baseline and make backend-specific capabilities explicit.
